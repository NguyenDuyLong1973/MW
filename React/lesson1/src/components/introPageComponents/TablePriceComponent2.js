...
class TablePriceComponent2 extends Component {
    render() {
        return (
            <div className="tablePriceComponent" >
                <div className="headerH2"><h2 className="h2TablePriceComponent">{this.props.typePrice}</h2></div>
                <div className="listItemTablePrice">
                    ...
                    <ItemTablePriceComponent text={this.props.text4} />
                </div>
                <hr />
...
export default TablePriceComponent2